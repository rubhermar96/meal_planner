    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-[color:hsl(var(--background))] relative overflow-hidden p-6 font-sans">
            ...
            <div className="absolute inset-0 z-0 pointer-events-none">
                <div className="absolute -top-[20%] -left-[10%] w-[70%] h-[70%] rounded-full bg-[color:hsl(var(--primary))] opacity-[0.15] blur-[100px] animate-pulse-slow"></div>
                <div className="absolute -bottom-[20%] -right-[10%] w-[60%] h-[60%] rounded-full bg-[color:hsl(var(--secondary))] opacity-[0.2] blur-[100px]"></div>
            </div>
            ...
            <div className="w-full max-w-sm relative z-10 animate-fade-in space-y-10 text-center md:text-left">
                ...
                <div className="flex flex-col items-center md:items-start">
                    ...
                    <p className="text-lg text-[color:hsl(var(--muted-foreground))] mt-3 font-medium">
                        Tu cocina te espera. Inicia sesión para empezar a planificar.
                    </p>
                </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative group">
                                ...
                                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none z-10">
                                    <UserIcon className="h-5 w-5 text-gray-400 group-focus-within:text-[color:hsl(var(--primary))] transition-colors" />
                                </div>
                                <input
                                    type="text"
                                    required
                        ...
                        <div className="space-y-2">
                            <div className="flex justify-between items-center ml-1">
                                <label className="text-sm font-bold text-[color:hsl(var(--foreground))] flex items-center gap-2">
                                    Contraseña
                                </label>
                                <a href="#" className="text-xs font-medium text-[color:hsl(var(--primary))] hover:underline">
                            ...
                            <div className="relative group">
                                {/* AÑADIDO Z-10 AQUÍ */}
                                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none z-10">
                                    <LockClosedIcon className="h-5 w-5 text-gray-400 group-focus-within:text-[color:hsl(var(--primary))] transition-colors" />
                                </div>
                                <input
                                    type="password"
                                    required
                        ...
                        >
                            {loading ? (
                                ...
                                <span className="flex items-center justify-center gap-2 font-bold">
                                    Iniciar Sesión <ArrowRightIcon className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                                </span>
                            )}
                        </button>
                    </form>
                ...
                <div className="text-center text-[color:hsl(var(--muted-foreground))] font-medium">
                    <p>
                        ...
                        <Link to="/register" className="font-bold text-[color:hsl(var(--primary))] hover:underline transition-all">
            ...
            {/* Footer Créditos */}
            <div className="absolute bottom-4 md:bottom-8 text-center w-full text-xs text-[color:hsl(var(--muted-foreground))] opacity-40 font-medium">
                © {new Date().getFullYear()} MealPlanner. Cocina inteligente.
            </div>
        </div>
    );
};